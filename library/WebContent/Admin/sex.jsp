...
<head>
	...
	<script src="${pageContext.request.contextPath}/Admin/static/js/echarts.min.js" ></script>
</head>
<body>
	...
	<p id="man" hidden>${sex.man} </p>
	<p id="women" hidden>${sex.woman } </p>
	<p id="empty_sex" hidden>${sex.unkonw } </p>
